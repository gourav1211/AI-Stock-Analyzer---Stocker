...
const Hero = () => {
  ...
  return (
    <div className="px-3 pt-2 bg-[#00063F] object-cover text-white pb-3">
      ...
      <div className="flex items-center justify-center">
        <button
          ...
          className="border-2 mt-2 mb-3 px-5 py-2 rounded-3xl hover:scale-95 hover:bg-white hover:text-black active:bg-white active:text-black cursor-pointer active:scale-95 duration-50 font-semibold active:border-white md:mt-1 md:px-20 md:py-6"
        >
          Try Now
        </button>
      </div>
